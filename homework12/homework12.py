...
if __name__ == '__main__':
    student_1 = Student("Iudin", "Evgenii", "Sergeevich", Path('lessons.csv'))
    student_1("русский язык", 2)
    student_1("физика", 3)
    student_1("математика", 4)
    student_1("информатика", 23, "test")
    student_1("математика", 85, "test")
    student_1("химия", 75, "test")
    student_1("химия", 2)
    ...
    student_2("история", 3)
    student_2("физика", 4)
    student_2("математика", 2)
    student_2("история", 65, "test")
    student_2("история", 85, "test")
    student_2("химия", 3)
    student_2("информатика", 4)
    student_2("информатика", 77, "test")
    student_2("история", 85, "test")
    print(student_2)